...
function App() {
  ...
  const handleRefine = async (e: React.FormEvent) => {
    ...
    try {
      // Send refinement instruction with style enforcement
      const instruction = `${refineInput}\n\nIMPORTANT: Return the updated content strictly as a valid JSON array, following the original format exactly. Maintain the strict 1-4 paragraph limit and minimalist formatting.`;
